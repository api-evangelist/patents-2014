...
5. The method of claim 4 wherein the completing dialogue agent application further comprises dialogue cloud with key words for search engines 

6. The method of claim 1 wherein the artificial intelligence agent is an avatar on a social media platform.
...
16. The method of claim 15 further comprising aggregating dialogue pathways from a plurality of individual targets.

17. The method of claim 15 further comprising determining a dollar value associated with each dialogue action.
...
22. The apparatus of claim 21 wherein the completing dialogue agent application further comprises dialogue cloud with key words for search engines 

23. The apparatus of claim 18 wherein the artificial intelligence agent is an avatar on a social media platform.

providing alternate questions to the individual target to obtain further information if the search fails and

32. The apparatus of claim 31 wherein the dialogue parameters comprises a number of dialogue actions in the dialogue pathway and an amount of time take for each dialogue action.

33. The apparatus of claim 32 wherein the processor further issues instructions for aggregating dialogue pathways from a plurality of individual targets.

34. The apparatus of claim 32 wherein the processor further issues instructions for determining a dollar value associated with each dialogue action.
...
39. The system of claim 38 wherein the completing dialogue agent application further comprises dialogue cloud with key words for search engines 

40. The system of claim 35 wherein the artificial intelligence agent is an avatar on a social media platform.

providing alternate questions to the individual target to obtain further information if the search fails and

49. The system of claim 48 wherein the dialogue parameters comprises a number of dialogue actions in the dialogue pathway and an amount of time take for each dialogue action.

50. The system of claim 49 further comprising means for aggregating dialogue pathways from a plurality of individual targets.

51. The system of claim 49 further comprising means for determining a dollar value associated with each dialogue action.
...
56. The medium of claim 55 wherein the completing dialogue agent application further comprises dialogue cloud with key words for search engines 

57. The medium of claim 52 wherein the artificial intelligence agent is an avatar on a social media platform.

providing alternate questions to the individual target to obtain further information if the search fails and

66. The medium of claim 65 wherein the dialogue parameters comprises a number of dialogue actions in the dialogue pathway and an amount of time take for each dialogue action.

67. The medium of claim 66 further storing processor issueable instructions for aggregating dialogue pathways from a plurality of individual targets.

68. The medium of claim 66 further storing processor issueable instructions for determining a dollar value associated with each dialogue action.
...
72. The method of claim 71 wherein a last response to the conversational dialogue resulting in a purchase warrants a further increased payment.

74. The method of claim 73 wherein the response performance of the artificial intelligence agent is recorded over multiple conversational dialogues with multiple individuals.

75. The method of claim 74 wherein response performance of the artificial intelligence agent may be compared to the performance of other artificial intelligence agents.

76. The method of claim 75 wherein artificial intelligence agents may be traded on an exchange based on their performance.

77. The method of claim 76 wherein recorded responses and conversational dialogues across the artificial intelligence may be mined for trend information.

79. The method of claim 69 further comprising determining an asset negotiator to negotiate a transaction between an asset owner and an investor.

80. The method of claim 69 further comprising generating an asset wrapper for the demanded digital conversation asset.

81. The method of claim 70 wherein the asset wrapper identifies an asset owner an asset author an asset negotiator for the digital conversation asset.
...
89. The apparatus of claim 88 wherein a last response to the conversational dialogue resulting in a purchase warrants a further increased payment.

90. The apparatus of claim 89 wherein the further increased payment is a percentage of the purchases.

91. The apparatus of claim 90 wherein the response performance of the artificial intelligence agent is recorded over multiple conversational dialogues with multiple individuals.

92. The apparatus of claim 91 wherein response performance of the artificial intelligence agent may be compared to the performance of other artificial intelligence agents.

93. The apparatus of claim 92 wherein artificial intelligence agents may be traded on an exchange based on their performance.

94. The apparatus of claim 93 wherein recorded responses and conversational dialogues across the artificial intelligence may be mined for trend information.

95. The apparatus of claim 86 wherein the type of digital conversation asset comprises at least one of 

96. The apparatus of claim 86 wherein the processor further issues instructions for determining an asset negotiator to negotiate a transaction between an asset owner and an investor.

97. The apparatus of claim 86 wherein the processor further issues instructions for generating an asset wrapper for the demanded digital conversation asset.

98. The apparatus of claim 87 wherein the asset wrapper identifies an asset owner an asset author an asset negotiator for the digital conversation asset.
...
106. The system of claim 105 wherein a last response to the conversational dialogue resulting in a purchase warrants a further increased payment.

108. The system of claim 107 wherein the response performance of the artificial intelligence agent is recorded over multiple conversational dialogues with multiple individuals.

109. The system of claim 108 wherein response performance of the artificial intelligence agent may be compared to the performance of other artificial intelligence agents.

110. The system of claim 109 wherein artificial intelligence agents may be traded on an exchange based on their performance.

111. The system of claim 110 wherein recorded responses and conversational dialogues across the artificial intelligence may be mined for trend information.

112. The system of claim 103 wherein the type of digital conversation asset comprises at least one of 

113. The system of claim 103 further comprising means for determining an asset negotiator to negotiate a transaction between an asset owner and an investor.

114. The system of claim 103 further comprising means for generating an asset wrapper for the demanded digital conversation asset.

115. The system of claim 104 wherein the asset wrapper identifies an asset owner an asset author an asset negotiator for the digital conversation asset.
...
123. The medium of claim 122 wherein a last response to the conversational dialogue resulting in a purchase warrants a further increased payment.

125. The medium of claim 124 wherein the response performance of the artificial intelligence agent is recorded over multiple conversational dialogues with multiple individuals.

126. The medium of claim 125 wherein response performance of the artificial intelligence agent may be compared to the performance of other artificial intelligence agents.

127. The medium of claim 126 wherein artificial intelligence agents may be traded on an exchange based on their performance.

128. The medium of claim 127 wherein recorded responses and conversational dialogues across the artificial intelligence may be mined for trend information.

129. The medium of claim 120 wherein the type of digital conversation asset comprises at least one of 

130. The medium of claim 120 further storing processor issuable instructions for determining an asset negotiator to negotiate a transaction between an asset owner and an investor.

131. The medium of claim 120 further storing processor issuable instructions for generating an asset wrapper for the demanded digital conversation asset.

132. The medium of claim 121 wherein the asset wrapper identifies an asset owner an asset author an asset negotiator for the digital conversation asset.
...
143. The method of claim 137 wherein the dialogue line comprises a hyperlink connected to a search engine.

144. The method of claim 137 wherein the dialogue line comprises a hyperlink connected to another dialogue agent application.

a processor disposed in communication with said memory and configured to issue a plurality of processing instructions stored in the memory wherein the processor issues instructions to 

generate a dialogue line in response to the received dialogue action via the dialogue agent application and

154. The apparatus of claim 148 wherein the dialogue line comprises a hyperlink connected to a search engine.

155. The apparatus of claim 148 wherein the dialogue line comprises a hyperlink connected to another dialogue agent application.
...
165. The system of claim 159 wherein the dialogue line comprises a hyperlink connected to a search engine.

166. The system of claim 159 wherein the dialogue line comprises a hyperlink connected to another dialogue agent application.

170. A digital conversation generating processor readable medium storing processor issuable instructions to 

generate a dialogue line in response to the received dialogue action via the dialogue agent application and

176. The medium of claim 170 wherein the dialogue line comprises a hyperlink connected to a search engine.

177. The medium of claim 170 wherein the dialogue line comprises a hyperlink connected to another dialogue agent application.

186. The method of claim 181 wherein the dialogue action is associated with one condition in response to the dialogue notice.

187. The method of claim 181 wherein the received dialogue line comprises a hyperlink connected to a search engine.

189. The method of claim 187 wherein the hyperlink comprises a search based on key words included in the dialogue action.

a processor disposed in communication with said memory and configured to issue a plurality of processing instructions stored in the memory wherein the processor issues instructions to 

195. The apparatus of claim 190 wherein the dialogue action is associated with one condition in response to the dialogue notice.

196. The apparatus of claim 190 wherein the received dialogue line comprises a hyperlink connected to a search engine.

198. The apparatus of claim 196 wherein the hyperlink comprises a search based on key words included in the dialogue action.

means to receive a dialogue line in response to the submitted dialogue action from the dialogue agent.

204. The system of claim 199 wherein the dialogue action is associated with one condition in response to the dialogue notice.

205. The system of claim 199 wherein the received dialogue line comprises a hyperlink connected to a search engine.

207. The system of claim 205 wherein the hyperlink comprises a search based on key words included in the dialogue action.

208. A digital conversation generating processor readable medium storing processor issuable instructions to 

213. The medium of claim 208 wherein the dialogue action is associated with one condition in response to the dialogue notice.

214. The medium of claim 208 wherein the received dialogue line comprises a hyperlink connected to a search engine.

216. The medium of claim 214 wherein the hyperlink comprises a search based on key words included in the dialogue action.

220. The method of claim 217 wherein the plurality of dialogue agent parameters comprise a number of dialogue agents and a selection of a dialogue platform.

a processor disposed in communication with said memory and configured to issue a plurality of processing instructions stored in the memory wherein the processor issues instructions to 

227. The apparatus of claim 224 wherein the plurality of dialogue agent parameters comprise a number of dialogue agents and a selection of a dialogue platform.

means to implement the dialogue agent application on the dialogue platform with an individual target.

234. The system of claim 231 wherein the plurality of dialogue agent parameters comprise a number of dialogue agents and a selection of a dialogue platform.

238. A digital conversation generating processor readable medium storing processor issuable instructions to 

241. The medium of claim 238 wherein the plurality of dialogue agent parameters comprise a number of dialogue agents and a selection of a dialogue platform.

facilitate a transaction of the financial instrument between an owner of the digital asset and an investor.

248. The method of claim 245 wherein the dialogue agent comprises an avatar identity on a social media platform.

250. The method of claim 245 wherein the digital asset is one of a conversation asset an artificial intelligence entity asset a portfolio asset and an exchange asset.

255. The method of claim 245 wherein the financial instrument comprises one of a future a forward and an option.

256. The method of claim 245 wherein the financial instrument comprises stock shares of the digital asset.

257. The method of claim 245 wherein the index of the financial instrument is measured in dialogue value units.

259. The method of claim 245 wherein the financial instrument is traded on a financial trading platform.

a processor disposed in communication with said memory and configured to issue a plurality of processing instructions stored in the memory wherein the processor issues instructions to 

facilitate a transaction of the financial instrument between an owner of the digital asset and an investor.

263. The apparatus of claim 260 wherein the dialogue agent comprises an avatar identity on a social media platform.

265. The apparatus of claim 260 wherein the digital asset is one of a conversation asset an artificial intelligence entity asset a portfolio asset and an exchange asset.

270. The apparatus of claim 260 wherein the financial instrument comprises one of a future a forward and an option.

271. The apparatus of claim 260 wherein the financial instrument comprises stock shares of the digital asset.

272. The apparatus of claim 260 wherein the index of the financial instrument is measured in dialogue value units.

274. The apparatus of claim 260 wherein the financial instrument is traded on a financial trading platform.

means to facilitate a transaction of the financial instrument between an owner of the digital asset and an investor.

278. The system of claim 275 wherein the dialogue agent comprises an avatar identity on a social media platform.

280. The system of claim 275 wherein the digital asset is one of a conversation asset an artificial intelligence entity asset a portfolio asset and an exchange asset.

285. The system of claim 275 wherein the financial instrument comprises one of a future a forward and an option.

286. The system of claim 275 wherein the financial instrument comprises stock shares of the digital asset.

287. The system of claim 275 wherein the index of the financial instrument is measured in dialogue value units.

289. The system of claim 275 wherein the financial instrument is traded on a financial trading platform.

290. A digital conversation exchange processor readable medium storing processor issuable instructions to 

facilitate a transaction of the financial instrument between an owner of the digital asset and an investor.

293. The medium of claim 290 wherein the dialogue agent comprises an avatar identity on a social media platform.

295. The medium of claim 290 wherein the digital asset is one of a conversation asset an artificial intelligence entity asset a portfolio asset and an exchange asset.

300. The medium of claim 290 wherein the financial instrument comprises one of a future a forward and an option.

301. The medium of claim 290 wherein the financial instrument comprises stock shares of the digital asset.

302. The medium of claim 290 wherein the index of the financial instrument is measured in dialogue value units.

304. The medium of claim 290 wherein the financial instrument is traded on a financial trading platform.
...
310. The method of claim 309 wherein the dialogue agent comprises an avatar identity on a social platform.

312. The method of claim 309 wherein the plurality of parameters comprises a pathway of the dialogue.

313. The method of claim 312 wherein the pathway is associated with a starting node and an ending node.

314. The method of claim 309 wherein the plurality of parameters comprises a number of dialogue steps in the dialogue.

315. The method of claim 309 wherein the plurality of parameters comprises an amount of time taken for each dialogue step.

316. The method of claim 309 wherein the value point allocated to each dialogue step is determined based on an outcome of the dialogue.

320. The method of claim 309 wherein the adjusting the allocated value point of each dialogue step is based on a supply demand relationship reflected by the received trading information.

a processor disposed in communication with said memory and configured to issue a plurality of processing instructions stored in the memory wherein the processor issues instructions to 

322. The apparatus of claim 321 wherein the dialogue agent comprises an avatar identity on a social platform.

324. The apparatus of claim 321 wherein the plurality of parameters comprises a pathway of the dialogue.

325. The apparatus of claim 324 wherein the pathway is associated with a starting node and an ending node.

326. The apparatus of claim 321 wherein the plurality of parameters comprises a number of dialogue steps in the dialogue.

327. The apparatus of claim 321 wherein the plurality of parameters comprises an amount of time taken for each dialogue step.

328. The apparatus of claim 321 wherein the value point allocated to each dialogue step is determined based on an outcome of the dialogue.

332. The apparatus of claim 321 wherein the adjusting the allocated value point of each dialogue step is based on a supply demand relationship reflected by the received trading information.

means to adjust the allocated value point of each dialogue step based on the received trading information.

334. The system of claim 333 wherein the dialogue agent comprises an avatar identity on a social platform.

336. The system of claim 333 wherein the plurality of parameters comprises a pathway of the dialogue.

337. The system of claim 336 wherein the pathway is associated with a starting node and an ending node.

338. The system of claim 333 wherein the plurality of parameters comprises a number of dialogue steps in the dialogue.

339. The system of claim 333 wherein the plurality of parameters comprises an amount of time taken for each dialogue step.

340. The system of claim 333 wherein the value point allocated to each dialogue step is determined based on an outcome of the dialogue.

344. The system of claim 333 wherein the adjusting the allocated value point of each dialogue step is based on a supply demand relationship reflected by the received trading information.

345. A digital conversation pricing processor readable medium storing processor issuable instructions to 

346. The medium of claim 345 wherein the dialogue agent comprises an avatar identity on a social platform.

348. The medium of claim 345 wherein the plurality of parameters comprises a pathway of the dialogue.

349. The medium of claim 348 wherein the pathway is associated with a starting node and an ending node.

350. The medium of claim 345 wherein the plurality of parameters comprises a number of dialogue steps in the dialogue.

351. The medium of claim 345 wherein the plurality of parameters comprises an amount of time taken for each dialogue step.

352. The medium of claim 345 wherein the value point allocated to each dialogue step is determined based on an outcome of the dialogue.

356. The medium of claim 345 wherein the adjusting the allocated value point of each dialogue step is based on a supply demand relationship reflected by the received trading information.
...
358. The method of claim 357 wherein the dialogue agent application is initialized on a social media platform.

359. The method of claim 357 wherein the dialogue agent application is initialized on a mobile platform.
...
368. The apparatus of claim 367 wherein the dialogue agent application is initialized on a social media platform.

369. The apparatus of claim 367 wherein the dialogue agent application is initialized on a mobile platform.
...
378. The system of claim 377 wherein the dialogue agent application is initialized on a social media platform.

379. The system of claim 377 wherein the dialogue agent application is initialized on a mobile platform.
...
388. The medium of claim 387 wherein the dialogue agent application is initialized on a social media platform.

389. The medium of claim 387 wherein the dialogue agent application is initialized on a mobile platform.
...
398. The method of claim 397 wherein dialogue agent application is initialized on a social media platform.

399. The method of claim 397 wherein the dialogue agent application is initialized on a mobile platform.
...
403. The apparatus of claim 402 wherein dialogue agent application is initialized on a social media platform.

404. The apparatus of claim 402 wherein the dialogue agent application is initialized on a mobile platform.
...
408. The system of claim 407 wherein dialogue agent application is initialized on a social media platform.

409. The system of claim 407 wherein the dialogue agent application is initialized on a mobile platform.
...
413. The medium of claim 412 wherein dialogue agent application is initialized on a social media platform.

414. The medium of claim 412 wherein the dialogue agent application is initialized on a mobile platform.

providing alternate questions to the individual target to obtain further information if the search fails and

a processor disposed in communication with said memory and configured to issue a plurality of processing instructions stored in the memory wherein the processor issues instructions to 

434. The apparatus of claim 431 wherein the processor further issues instructions for dialogue cloud with key words for search engines.

providing alternate questions to the individual target to obtain further information if the search fails and

means to incorporate information from the list of search results in a record related to the key word.

448. The system of claim 445 further comprising means for dialogue cloud with key words for search engines.

providing alternate questions to the individual target to obtain further information if the search fails and

459. A digital conversation management processor readable medium storing processor issuable instructions to 

462. The medium of claim 459 further storing instructions for dialogue cloud with key words for search engines.

providing alternate questions to the individual target to obtain further information if the search fails and

generating a dialogue tree by connecting the dialogue node to a different dialogue node based on each condition and

475. The method of claim 473 wherein the dialogue tree application and the dialogue script generating panel are launched in a slit screen via the user interface.

476. The method of claim 473 wherein the dialogue tree comprises a plurality of connected dialogue nodes.

480. The method of claim 479 wherein the decision tree is determined by a pathway on the dialogue tree via a conditional logic.

a processor disposed in communication with said memory and configured to issue a plurality of processing instructions stored in the memory wherein the processor issues instructions to 

generate a dialogue tree by connecting the dialogue node to a different dialogue node based on each condition and

486. The apparatus of claim 485 wherein the dialogue agent application is initialized by a developer.

487. The apparatus of claim 485 wherein the dialogue tree application and the dialogue script generating panel are launched in a slit screen via the user interface.

488. The apparatus of claim 485 wherein the dialogue tree comprises a plurality of connected dialogue nodes.

491. The apparatus of claim 485 wherein the processor further issues instructions for generating a decision tree.

492. The apparatus of claim 491 wherein the decision tree is determined by a pathway on the dialogue tree via a conditional logic.
...
499. The system of claim 497 wherein the dialogue tree application and the dialogue script generating panel are launched in a slit screen via the user interface.

500. The system of claim 497 wherein the dialogue tree comprises a plurality of connected dialogue nodes.

504. The system of claim 503 wherein the decision tree is determined by a pathway on the dialogue tree via a conditional logic.

509. A digital conversation generating processor readable medium storing processor issuable instructions to 

generate a dialogue tree by connecting the dialogue node to a different dialogue node based on each condition and

511. The medium of claim 509 wherein the dialogue tree application and the dialogue script generating panel are launched in a slit screen via the user interface.

512. The medium of claim 509 wherein the dialogue tree comprises a plurality of connected dialogue nodes.

515. The medium of claim 509 wherein the processor further issues instructions for generating a decision tree.

516. The medium of claim 515 wherein the decision tree is determined by a pathway on the dialogue tree via a conditional logic.
...
523. The method of claim 521 wherein the initial prompt is obtained from Wiki submission from a plurality of users.

a processor disposed in communication with said memory and configured to issue a plurality of processing instructions stored in the memory wherein the processor issues instructions to 

sending the obtained initial prompt the plurality of agent dialogue conditions each specified condition trigger the subsequent prompt for each triggered conditional dialogue branch the search link to a server for dialogue agent registration.

527. The apparatus of claim 525 wherein the initial prompt is obtained from Wiki submission from a plurality of users.
...
531. The system of claim 529 wherein the initial prompt is obtained from Wiki submission from a plurality of users.
...
535. The medium of claim 533 wherein the initial prompt is obtained from Wiki submission from a plurality of users.
...
542. The method of claim 541 wherein the search engine query is based on a key word submitted by a user.

544. The method of claim 541 wherein the updating the search engine query result based on the obtained responses further comprises refining the search engine query based on related key words from the obtained responses.

545. The method of claim 542 further comprising increasing a charge to a dialogue search agent sponsor for each obtained dialogue response.

a processor disposed in communication with said memory and configured to issue a plurality of processing instructions stored in the memory wherein the processor issues instructions to 

update the search engine query result based on the obtained responses by using dialogue search agent search links.

547. The apparatus of claim 546 wherein the search engine query is based on a key word submitted by a user.

549. The apparatus of claim 546 wherein the updating the search engine query result based on the obtained responses further comprises refining the search engine query based on related key words from the obtained responses.

550. The apparatus of claim 547 further comprising increasing a charge to a dialogue search agent sponsor for each obtained dialogue response.
...
552. The system of claim 551 wherein the search engine query is based on a key word submitted by a user.

554. The system of claim 551 wherein the updating the search engine query result based on the obtained responses further comprises refining the search engine query based on related key words from the obtained responses.

555. The system of claim 552 further comprising means for increasing a charge to a dialogue search agent sponsor for each obtained dialogue response.
...
557. The processor implemented medium of claim 556 wherein the dialogue agent loader instantiate the dialogue search agent.

558. The processor implemented medium of claim 556 wherein the dialogue agent loader is triggered by a user selection.

559. The medium of claim 556 wherein the search engine query is based on a key word submitted by a user.

561. The medium of claim 556 wherein the updating the search engine query result based on the obtained responses further comprises refining the search engine query based on related key words from the obtained responses.

562. The medium of claim 559 further storing instructions for increasing a charge to a dialogue search agent sponsor for each obtained dialogue response.
